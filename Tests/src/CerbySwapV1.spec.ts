const Cerby = artifacts.require("WETH9");

contract("Cerby", accounts => {
  it("should put 10000 MetaCoin in the first account", async () => {
    const some = await web3.eth.getAccounts();
  ...
  //     await metaCoinInstance.getBalance(accounts[0])
  //   ).toNumber();
  //   const metaCoinEthBalance = (
  //     await metaCoinInstance.getBalanceInEth(accounts[0])
  //   ).toNumber();
